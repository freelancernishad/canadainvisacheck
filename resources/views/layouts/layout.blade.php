...
<body>
    ...
    <section id="sticky-menu" class="rounded ">
        <div class="bg-white">
            <div class="row">
                <div class="col-md-4">
                ...
                <div class="col-md-5 d-flex gap-4 my-auto">
                    <a class="fs-6 fw-bold navv-a px-3 py-1 py-2 text-decoration-none" href="/">HOME</a>
                    <a class="fs-6 fw-bold navv-a px-3 py-1 py-2 text-decoration-none" href="{{ url('contact-us') }}">CONTACT US</a>
                    <a class="fs-6 fw-bold navv-a px-3 py-1 py-2 text-decoration-none" href="{{ url('about-us') }}">ABOUT US</a>
                </div>
                <div style="background-color: #FF0000; display: flex; align-items: center;" class="col-md-3">
                    <h4 style="color: #354054;" class="fs-4 mb-0">Check Visa Status</h4>
                </div>
            </div>
        </div>
    </section>
        ...
        <footer style="background-color: #922713;" class=" text-white  py-3">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <p>Iaculis duis dictum libero consequat nec curae mus luctus, rhoncus vitae quam justo nullam quis
                            tempus rutrum
                        </p>
                        <div>
                    ...
                    <div class="col-md-3">
                        <h5>Newsletter</h5>
                        <p>Lorem ipsum dolor sit amet consectetur adipiscing elit, vel sociis scelerisque dis euismod
                            accumsan urna</p>
                        <form class="d-flex">
